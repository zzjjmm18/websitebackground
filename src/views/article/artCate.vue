<template>
  <div>
    ...
    <!-- 添加分类的对话框 -->
<el-dialog :title="isEdit ? '编辑文章分类' : '添加文章分类'" :visible.sync="addVisible" width="35%" @closed="cancelFn">
    <span>
      <!-- 添加的表单 -->
<el-form :model="addForm" :rules="addRules" ref="addRef" label-width="80px">
  ...
  <el-form-item label="分类别名" prop="cate_alias">
    ...
    <span slot="footer" class="dialog-footer">
        ...
        <el-button size="mini" type="primary" @click="addFn">添加</el-button>
    </span>
</el-dialog>
  </div>
</template>
...
<script>
import { getArtCateListAPI, addArtCateAPI, updateArtCateAPI, delArtCateAPI } from '@/api/article'
export default {
  name: 'ArtCate',
  data () {
    return {
